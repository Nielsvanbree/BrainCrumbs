      ...
      <div className="flex-grow pt-32 pb-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto w-full">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Beyond the hype. Deep analysis on LLMs, agents, and the synthetic intelligence revolution.
          </p>
        </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-12">
             <div>
                ...
                <ul className="space-y-4">
                  {['Research paper breakdowns', 'Prompt engineering deep dives', 'AI safety & ethics discussions', 'Tools for the AI-augmented dev'].map((item) => (
             ...
             <div className="text-sm text-gray-400 bg-black/30 p-6 rounded-xl border border-white/5">
               <p className="mb-4 italic">"The only newsletter that actually explains how the models work instead of just listing new tools."</p>
               <p className="font-bold text-white">— Marcus R., ML Engineer</p>
             </div>
           </div>
